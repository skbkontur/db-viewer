...
export const EightPx = (): JSX.Element => <ErrorContainer theme={DEFAULT_THEME_8PX} />;
export const Dark = (): JSX.Element => <ErrorContainer theme={ThemeFactory.create(reactUiDark)} />;
export const InfraDark = (): JSX.Element => <ErrorContainer theme={ThemeFactory.create(infraUiDark)} />;
